...
if (isset($_SESSION['id'])) 
{
	//admin
	if ($_SESSION['type']==0){
		echo '<h1><a href="reg_controller.php">Переход на рабочую страницу менеджера по покупкам</a></h1>';
		echo '<h1><a href="reg_controller.php">Переход на рабочую страницу менеджера по продажам</a></h1>';
		echo '<h1><a href="reg_controller.php">Регистрация нового менеджера</a></h1>';
...
?>
 ...
 <h1><a href="scripts/exit.php">Выход</a></h1>
 	</div>
  </section>
   	</div>
  </section>
